...
class Eval_thread():
    def __init__(self, epoch, model, loader, dataset, method, txt_name, output_dir, cuda):
        self.model = model #
        model.eval() 
        ...
        self.logfile = os.path.join(output_dir, txt_name)
    ...
    def Eval_mae(self):
        ...
        with torch.no_grad():
            for img, gt, scene, name in tqdm(self.loader):  
