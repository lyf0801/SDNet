...
if __name__ == '__main__':  
    ...
    for method_name in method_names:
        for dataseti in dataset_name:
            ...
            smap_path = "D:/optical_RSIs_SOD/proposed_SASOD/data/output/predict_smaps_" + method_name + "_" + dataseti + "/"
            ...
            thread = Eval_thread(smap_path=smap_path, loader = test_loader, method = method_name, dataset = dataseti, output_dir = "D:/optical_RSIs_SOD/proposed_SASOD/data/", cuda=False)#backbone_ablation/
            logg, fm = thread.run()
            print(logg)
